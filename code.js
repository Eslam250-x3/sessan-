           ...
           if (fileId) {
               try {
                   ...
                   blocks.forEach((block) => {
                       ...
                       if (match) allBankQuestionIds.add(match[1]);
                   });
               } catch (e) {
           ...
           if (fileId) {
               try {
                   ...
                   blocks.forEach((block, index) => {
                       ...
                       if (slideData) {
                           // منطق unlinked الصحيح: فقط الأسئلة في الحصة وغير موجودة في أي بنك
                           if (isSessionFormat && slideData.isQuestion && slideData.questionId && !allBankQuestionIds.has(slideData.questionId)) {
